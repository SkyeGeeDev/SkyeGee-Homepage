...
const MyTextInput = ({label, ...props } : {label : string; name: string; type: string; placeholder: string; id: number}) => {
...
const MySelect = ({label, ...props } : {label: string; name: string; id: number}) => {
  const [field, meta] = useField(props);
  return (
    <div className='py-4'>
...
const MyTextArea = ({label, ...props} : {label: string; name: string; rows: string; placeholder: string; id: number;}) => {
  const [field, meta] = useField(props);
  return (
      <div className='py-4'>
          <label htmlFor={props.id || props.name}>{label}</label>
