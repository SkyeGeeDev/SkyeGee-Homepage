...
const RPS = (props: any) => {
  ...
  return (
    <div className='pb-8 px-2 md:px-10 border-2 rounded-lg place-content-center item-center bg-dblue'>
        <div className='mt-4 cursor-pointer' onClick={back}>
            <IoMdArrowBack size={30}/>
        </div>
        <div className='text-center pb-8'>
            <p className='text-lg lg:text-xl py-4'>Scoreboard</p>
        ...
        <div className='text-center pb-4 text-lg lg:text-xl' id='result'>
            Choose One
        </div>
        <div className='flex flex-col lg:flex-row text-center space-y-4 lg:space-x-4 lg:space-y-0 pb-8 place-items-center'>
        ...
        <div className='flex flex-col lg:flex-row text-center lg:space-x-8 justify-center place-items-center'>
            <div className=''>
                <p>Player Choice:</p>
