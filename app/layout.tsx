...
const permanent = Permanent_Marker({ subsets: ['latin'] , display: 'block' , weight: ['400'] , variable: '--font-permanent-marker'});
const inter = Inter({ subsets: ['latin'] , display : 'block' , variable: '--font-inter'});
